  ...
  return (
    <section className="bg-white py-20 px-6 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p
            className="text-black/35 text-[10px] uppercase mb-5"
          ...
          <h2
            className="text-[2.6rem] md:text-5xl text-black leading-[1.12] tracking-tight mb-5"
            style={ALBERT}
          >
          ...
          <p
            className="text-black/45 text-[15px] leading-relaxed max-w-md mx-auto mb-9"
            style={GEIST}
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-0 bg-black text-white pl-6 pr-1.5 py-1.5 rounded-full hover:bg-black/80 transition-colors"
          >
            <span
        ...
        {/* ── Cards wrapper ── */}
        <div className="bg-[#ececec] rounded-3xl p-3">
          <LayoutGroup>
            <div className="hidden md:flex gap-3">
              {CARDS.map((card, i) => (
                <motion.div
                  ...
                  className="relative bg-white rounded-2xl overflow-hidden cursor-default"
                  style={{
                    minHeight: '280px',
                ...
                >
                  ...
                  <div className="absolute bottom-5 left-5 right-[48%] z-10">
                    <h3
                      className="text-black text-[1.05rem] font-semibold leading-snug mb-1.5"
                      style={ALBERT}
                    >
                      {card.title}
                    </h3>
                    <p
                      className="text-black/45 text-[12px] leading-relaxed"
                      style={GEIST}
                    >
                      {card.description}
                    </p>
              ...
              {CARDS.map((card, i) => (
                ...
                >
                  ...
                  <div className="absolute bottom-5 left-5 right-5 z-10">
                    <h3 className="text-black text-[1.05rem] font-semibold leading-snug mb-1.5" style={ALBERT}>
                      {card.title}
                    </h3>
                    <p className="text-black/45 text-[12px] leading-relaxed" style={GEIST}>
                      {card.description}
                    </p>
                  </div>
                </motion.div>
