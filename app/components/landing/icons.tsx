/** Iconos compartidos por las secciones de landing. Sin estado: valen en servidor y cliente. */
...
export function StarRow({ count = 5 }: { count?: number }) {
  return (
    <div className="flex items-center gap-1" aria-label={`${count} estrellas`}>
