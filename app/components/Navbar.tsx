        ...
        <div className="flex items-center justify-between md:justify-center px-4 py-2.5 gap-4 md:gap-15">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <a
              ...
              className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-full text-white/80 hover:text-white border border-white/15 hover:border-white/30 transition-colors text-[11px] uppercase tracking-wider font-medium"
            >
